...
class DeskDocumentData {
  ...
  /// Creates a [DeskDocumentData] from a JSON map.
  factory DeskDocumentData.fromJson(Map<String, dynamic> json) {
  ...
  @override
  String toString() {
    return 'DeskDocumentData(id: $id, documentType: $documentType, data: $data)';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is DeskDocumentData &&
        other.id == id &&
