  ...
  children: [
    ...
    SizedBox(
      ...
      child: ValueListenableBuilder<ImageReference>(
        ...
        builder: (_, ref, _) =>
            DeskFrame(ref: ref, child: const MockPhoto()),
      ),
    ),
  ],
);
...
void main() {
  testGoldenScene('DeskFrame live-edit timeline', (tester) async {
    await Timeline(
        ...
        .takePhoto('1. raw upload — cover centers, sun almost lost in 1:1 / 9:16')
        ...
        .takePhoto('2. editor pins hotspot on the sun → sun stays centered in every frame')
        .modifyScene((tester, _) async {
          _ref.value = ImageReference(
            publicUrl: _ref.value.publicUrl,
            width: _ref.value.width,
        ...
        .takePhoto('3. editor crops out the watermark band → cleaner composition')
        .modifyScene((tester, _) async {
          _ref.value = ImageReference(
            publicUrl: _ref.value.publicUrl,
            width: _ref.value.width,
        ...
        .takePhoto('4. editor moves hotspot to the person → all frames re-center on them')
        .run(tester);
  });
}
