...
final integrationTestDocumentType = DocumentType(
  ...
  fields: [
    const DeskStringField(name: 'title', title: 'Title'),
    const DeskTextField(name: 'body', title: 'Body'),
    const DeskImageField(name: 'image_field', title: 'Image'),
    const DeskFileField(name: 'file_field', title: 'File'),
  ],
