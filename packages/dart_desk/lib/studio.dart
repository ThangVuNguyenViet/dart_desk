...
// Common components
export 'src/studio/components/common/desk_breadcrumbs.dart';
...
export 'src/studio/components/common/default_desk_header.dart';
export 'src/studio/components/forms/desk_form.dart';
export 'src/studio/components/navigation/desk_document_type_sidebar.dart';
export 'src/studio/components/version/desk_version_history.dart';
// Config
export 'src/studio/config/desk_breakpoints.dart';
...
export 'src/studio/core/view_models/desk_view_model.dart';
