// flutter_cms/packages/flutter_cms/lib/src/studio/components/common/cms_breadcrumbs.dart
...
class CmsBreadcrumbs extends StatelessWidget {
  final List<BreadcrumbSegment> segments;

  const CmsBreadcrumbs({super.key, required this.segments});
