...
class DefaultDeskHeader extends StatelessWidget {
  final String? name;
  final String title;
...
class DefaultDeskHeaderConfig extends InheritedWidget {
  final String title;
  final String? subtitle;
  final IconData? icon;
  final String? dashboardUrl;

  const DefaultDeskHeaderConfig({
    super.key,
    required this.title,
    this.subtitle,
    this.icon,
  ...
  @override
  bool updateShouldNotify(DefaultDeskHeaderConfig oldWidget) {
