// dart_desk/packages/dart_desk/lib/src/studio/components/common/desk_theme_toggle.dart
...
class DeskThemeToggle extends StatelessWidget {
  final ThemeMode themeMode;
  final ValueChanged<ThemeMode> onChanged;

  const DeskThemeToggle({
    super.key,
